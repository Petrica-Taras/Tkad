...
from wx import Panel, GridBagSizer, Notebook
...
class mainPanel(Panel):
    ...
    def addtoPanel(self, widget, position):
        if (position == (1, 1, 1) or position == (2, 0, 2)) and position in self.widgets.keys():
            ...
            self.sizer.Add(widget, pos = (position[0], position[1]), span = (1, position[2]), flag=wx.EXPAND|wx.ALL)
